...
void wifi_init_sta(const char* initSSID, const char* initPass)
{
  ...
  ESP_LOGI(TAG, "string size: %d", sizeof(wifi_config.sta.ssid));
...
int RadioNetwork::init(const char* ssid, const char* passwd)
{
